...
For reference, I also measured the overhead added in the `webRequest.onBeforeRequest` handler of two other popular blockers, Ghostery and Disconnect, and here are the results:
