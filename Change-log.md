...
**IMPORTANT:** I develop and test HTTPSB using the latest official release of Chromium (tested on v33), Chrome (tested on v34) and Opera (tested on v20). Once in a while I will test the official release of Yandex (it has been a while though). I guess I should set-up a development version of Chromium, but I do not have much time currently to do so. I know it often happens people reports that HTTPSB has some malfunction with some development version of a Chromium-based browser, malfunctions which I can reproduce on an official release.
