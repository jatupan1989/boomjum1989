...
- **New feature**: Ability to use the matrix on behind-the-scene requests.
    * Since the matrix reflects the network traffic of a web page, in order to see the matrix for behind-the-scene requests I had to pick a web page to allow for this.
