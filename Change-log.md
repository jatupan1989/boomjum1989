Starting with version 1.0.0.2, the log will now be at <https://github.com/gorhill/httpswitchboard/releases>. This is the proper Github way to release versions. Thanks to [mikhaelkh](/mikhaelkh) for the [tip](/gorhill/httpswitchboard/issues/368).
