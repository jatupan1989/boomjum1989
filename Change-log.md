...
### 0.8.4.2
- Fixed a bug which could potentially occur (depending on how fast the lists are loaded into memory) when loading the various ubiquitous lists, causing the extension to break.
