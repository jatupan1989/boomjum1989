...
- Fixed <https://github.com/gorhill/httpswitchboard/issues/225>: " 'slashdot.org' site is blocked when using 'fanboy-annoyance.txt' ".
    * HTTPSB now supports the parsing and enforcement of the [ABP's third-party` condition](https://adblockplus.org/blog/recognizing-third-party-content) for ABP complex filters.
