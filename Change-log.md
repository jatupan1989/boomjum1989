...
- [URL redirections](https://github.com/gorhill/httpswitchboard/wiki/URL-redirections) are now reported in the matrix of the landing page.
    * URL redirections are recognizabled by a group of domain/subdomains in the matrix for which all the cells are empty (but please read more here).
