...
- Reduced memory footprint.
    * Not that there was any memory leaks, just that for this release I chose to spend more time on code revision and refactoring. More planned for the future.
