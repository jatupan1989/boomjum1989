...
- **"Plugin"** column in the matrix is no longer blacklisted by default for first install. **It is strongly recommended** that users enable "Click to play" for plugins in their Chromium-based browser settings.
