...
- **New feature**: Auto-create temporary site-level scope (enable from *Settings* page)
    ...
    * Keep in mind the site-level scope created is **temporary**, unless you persist it (padlock).
        - Currently planning to have an option to flush temporary scopes and rules after *x* minutes of being unused, in order to avoid runtime bloat of temporary scopes/rules.
