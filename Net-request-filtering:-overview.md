...
Now this is the key part: **HTTPSB had an extra 56,000+ blocked hosts as matrix-filtering rules** (those rules are enabled out-of-the-box), and yet despite this, HTTPSB runs much leaner and faster than ABP, as seen above. <sub>(I still have an extra improvement in store to further reduce memory footprint regarding the implementation of ABP filters, but I do not consider this a priority at this point).</sub>
