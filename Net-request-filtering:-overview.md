...
<p align="center">
    ...
    <sup>CPU footprint: Average time spent to process each single net request: ABP vs. HTTPSB (for the CPU benchmark, matrix filtering was enabled in HTTPSB in allow all/block exceptionally mode)</sup>
</p>
