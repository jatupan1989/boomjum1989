Target test page: [front page of wired.com](http://www.wired.com).

The statistics on this page were generated by copying/pasting the contents of the Chromium's network tab into this [online utility](http://raymondhill.net/httpsb/har-parser.html). Be sure to clear the browser cache between every run in order to compare meaningfully. Number in *cookies* columns represents the number of distinct cookies sent to the remote server(s).

| hostnames | cookies | javascript | images | bandwidth |
| ---:| ---:| ---:| ---:| ---:|
