...
Correction: I gave more thought on this, and there is a way I could make Chromium/Chrome broad rules fit fine-grained HTTPSB: by using per-page permissions. Example: User has existing Chromium/Chrome rule to allow `www.youtube.com`, thus HTTPSB would create the following page-scoped rule:
