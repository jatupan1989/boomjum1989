...
After having read how Privacy Badger works, I actually think it is an excellent complementary extension to use aside HTTPSB, **especially** if you use HTTPSB in permissive way. Just be sure to install it **after** HTTPSB has been installed.
