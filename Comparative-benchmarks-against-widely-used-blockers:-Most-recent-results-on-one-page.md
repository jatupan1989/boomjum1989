...
The most important figure in my opinion with regard to privacy is the 3rd-party _Domain_ count, hence the ordering for left-to-right using the 3rd-party domain count figures.
