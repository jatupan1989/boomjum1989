...
I have to say I was rather surprised to see that ABP complex filters still contributed to block over 22% of requests even when using HTTPSB with it's very restrictive out-of-the-box settings.