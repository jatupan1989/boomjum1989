...
[**Edit:** after filter coverage has been extended to 99%, the number of CSS rules injected into Wired's front page is now eight: (`#header + #content > #left > #rlblock_left`, `.displayAd`, `.widget_widget_widgetwiredadtile`, `.WiredWidgetsMarketing`, `#post_nav`, `#magazine_rightRail_A`, `#leaderboard,#featured`)].
