...
<sup>**Important:** If you want to repeat the test above, be sure that **no other extensions** are enabled, as these may also add their own footprint to the web page.</sup>
