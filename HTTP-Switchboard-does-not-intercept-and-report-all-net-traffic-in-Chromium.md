...
So far this is what has been found on Chromium Version 31.0.1650.63 Built on Ubuntu 13.04, running on LinuxMint 15. No extension was installed, aside HTTPSB which was installed locally, using the _Load unpacked extension..._ tool.
...
Where "?" is a single digit. It occurs roughly every two hours. Probably related to `content::ResourceRequestInfo::IsSensitiveURL`?

```
https://code.google.com/p/chromium/codesearch#chromium/src/chrome/browser/extensions/api/web_request/web_request_permissions.cc&sq=package:chromium&l=24
```