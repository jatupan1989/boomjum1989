...
So if after thorough investigation you really can't associat a particular behind-the-scene request with one of the URL address of one of the opened tabs, then you probably made a convincing case that the particular behind-the-scene request was really expressly made by the browser behind the scene.
