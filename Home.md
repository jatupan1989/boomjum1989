...
- [HTTP Switchboard "seems to need more micromanagement" compared to NoScript](https://github.com/gorhill/httpswitchboard/wiki/HTTP-Switchboard-%22seems-to-need-more-micromanagement%22-compared-to-NoScript)
