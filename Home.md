...
- [_HTTP Switchboard_ "seems to need more micromanagement" compared to _NoScript_](https://github.com/gorhill/httpswitchboard/wiki/HTTP-Switchboard-%22seems-to-need-more-micromanagement%22-compared-to-NoScript)
