...
**Note:** Starting June 4th, 2014, only _EasyList_, _EasyPrivacy_ and malware protection filters (or equivalent) are going to be used for Adblock Plus and Adblock, or whatever equivalent for other blockers. I just realized that _ABP_ and _Ghostery_ settings were much more aggressive than _HTTPSB AA/BX_ for benchmarks ran before June 4th, 2014. (Specialized _Fanboy_ lists were not enabled for _HTTPSB_, while equivalent were for ABP and Ghostery).
